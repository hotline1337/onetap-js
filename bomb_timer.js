 ...
 * Title: Bomb timber
 * Author: leed
 * Coming: Bomb damage (when onetap will be able to get armor value smh)
*/
...
{
    var player_pos = entity_get_prop(player_entity, "CBaseEntity", "m_vecOrigin");
    var bomb_pos = entity_get_prop(bomb_entity, "CTEPlantBomb", "m_vecOrigin");
...
function on_paint()
{
    ...
    if (planted)
    {
        if (bomb_entity != null)
        {
            ...
            //const bomb_damage = getBombDamage(local_player, c4); //Will be added when ArmorValue prop will be fixed
        ...
        // Will be added when ArmorValue prop will be fixed
        //var damage_text= entity_get_prop(local_player, "CBasePlayer", "m_iHealth") <= bomb_damage ? "FATAL" : "-" + bomb_damage.toString() + " HP";
        //var damage_color = entity_get_prop(local_player, "CBasePlayer", "m_iHealth") <= bomb_damage ? [230,235,145, 255] : [255,1,1,255];
        //render_string(17, 2, 0, planted_text, [0, 0, 0, 255], 4);
        //render_string(15, 0, 0, damage_text, damage_color, 4);
    }
}
